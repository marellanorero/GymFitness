...
/*
    ...
    Version: 1.0.0
    Author: M° Laura Arellano Norero
    Author URI: http://marellanonorero.com
    Text Domain: gymfitness
*/

//Función de wp para que no se puede ingresas directamente a la información del plugin
...
function gymfitness_clases_post_type() {
	...
	$args = array(
		...
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail' ), //que habilitarás de lo que tiene wp para usarse en tu post type
		'hierarchical'          => true, // true = posts , false = paginas
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true, //lo integras a la interfaz de wp
        'menu_position'         => 6,
...
function gymfitness_instructores_post_type() {
	...
	$labels = array(
		...
		'all_items'             => __( 'Todos Las Instructores', 'gymfitness' ),
...
function gymfitness_testimoniales_post_type() {
	$labels = array(
		...
		'all_items'             => __( 'Todos Las Testimoniales', 'gymfitness' ),
